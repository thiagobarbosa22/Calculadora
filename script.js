...
function gerarOferta() {
    ...
    if (totalSva > 0) {
        ...
        if (ab === "1") {
            ...
            msg = "Preparei uma condition especial só para você, " + nome + ": atualizei o valor do seu plano para apenas " + f(novo) + " por " + meses + " meses" + txtIsencao + ". Fica melhor assim para você? Posso confirmar no sistema?";
        } else if (ab === "4") {
